...
const TestimonialSection: React.FC<TestimonialProps> = ({ content, name, designation }) => {
    return (
        <>
            <div className="group flex flex-col px-6 pt-8 pb-6 md:px-8 md:pb-8 relative border border-gray-200 drop-shadow-2xl-xl rounded-lg bg-white bg-opacity-25">
                <div className="absolute top-0 right-0 text-7xl mt-3 mr-4 text-gray-300 opacity-75 font-serif">“</div>
                <blockquote className="grow flex flex-col relative">
                    <div className="mb-6">
                        <div className="inline-flex items-center text-red-500 bg-red-200 border border-red-200 px-2 py-1 drop-shadow-2xl-lg transition ease-out origin-top-left group-hover:scale-110 rounded-lg">
                    ...
                    <p className="grow text-sm text-gray-200 font-medium leading-relaxed mb-5">
                        {content}
                    </p>
