    ...
    return (
        <>
            ...
            <footer id="page-footer" className="">
                <div className="container xl:max-w-7xl mx-auto px-4 pt-16 pb-8 lg:px-8 lg:pt-32 lg:pb-8">
                    ...
                    <div className="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm">
                        ...
                        <div className="text-gray-300">
                            <span className="font-medium text-gray-400">Website developed by <a href="https://github.com/a-singh09" target="_blank" className="underline text-red-500 hover:text-red-200">Anshdeep Singh</a></span>
                        </div>
                    </div>
                </div>
            </footer>
